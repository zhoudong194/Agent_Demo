...
SYSTEM_PROMPT = (
    "你是一个私人助理。请严格按 ReAct 风格思考:\n"
    "1. 每次回复先输出 Thought: <你的推理过程>,说明当前缺什么信息、为什么需要调用某个工具。\n"
    "2. 思考完毕后再调用工具作为Act执行，一次只调一个工具。\n"
    "3. 收到 Observation 后,把它当成真实数据继续推理;信息不够就再来一次循环。\n"
    "4. 当且仅当信息充分时才给出最终答案,开头加一句'主人你好!'，给出答案时不要再调用任何工具了。\n"
)
...
#
#  第1轮思考
# Thought: 需要知道“前年”是哪一年，才能确定对应入学年级（如2022级、2023级等），因此先调用 get_time 获取当前日期时间，再推算前年。
#
# tool_name: get_time
#
# tool_json: {}
#
# Observation[get_time]: "2026-07-31T10:54:28"
#
#  第2轮思考
# Thought: 当前时间是2026年7月31日，因此“前年”指2024年。通常大学/学院入学年份对应“XX级”，即2024年入学的学生为“2024级”。现在需要查询2024级所有学生信息，调用 query_students 并传入 grade="2024级"。
#
#
...
#
# - 张三，计算机科学与技术专业，计科1班，GPA 3.85
# - 李四，软件工程专业，软工2班，GPA 3.72
# - 孙八，软件工程专业，软工1班，GPA 3.88
# - 郑十一，数据科学专业，数据2班，GPA 3.55
